...
function preload(){
  ...
  zombie1=loadImage("pic/zombie1.png")
  zombie2=loadImage("pic/zombie2.png")

  zombie3=loadImage("pic/zombie3.png")
...
boy1.addAnimation("left to right",zombie1,zombie2,zombie1);
boy1.addAnimation("right to left ",zombie3,zombie4,zombie3)
boy1.addImage("saddy",sadzombie)
boy1.scale=0.1
boy1.velocityX=2
...
function draw() {
  ...
  for (var stone of stones) {
    ...
    if (boy1.position.x >= width - 300 && !collided) {
      boy1.velocityX = -10;
      boy1.changeAnimation("right to left");
    }
   
    if (boy1.position.x <= 300 && !collided) {
      boy1.velocityX = 10;
      boy1.changeAnimation("left to right");
